...
# MAGIC %sql
# MAGIC select schema_of_json ('{"order_id":"000000007090","order_timestamp":"2022-07-20 19:06:00","customer_id":"C00985","quantity":2,"total":82,"books":[{"book_id":"B07","quantity":1,"subtotal":33},{"book_id":"B01","quantity":1,"subtotal":49}]}') as schema_order

# COMMAND ----------

# MAGIC %sql
# MAGIC select cast(key as string), cast(value as string),topic from bronze
...
# MAGIC %sql
# MAGIC create table demo(id int primary key, name string) 
